export const TURNOS = {
  ...
  "Apoyo 3":    { label: "Apoyo 3",    horas: "17:00-22:00", tipo: "apoyo",    bg: "#F3C56E", fg: "#5f3a0e" },
...
export const TURNO_OPCIONES = ["Mañana", "Tarde", "Apoyo 1", "Apoyo 2", "Apoyo 3", "Descanso", "Vacaciones", "Baja", "Permiso"];
